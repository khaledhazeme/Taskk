...
public class LoginNewUser {
     ...
     By Authen = By.xpath("//span[contains(text(),'Authentication')]");
    ...
    public void loginUser(){
        wait.until(ExpectedConditions.presenceOfElementLocated(Authen));
     ...
     public void logOutUser(){//*[@id="center_column"]/h1
