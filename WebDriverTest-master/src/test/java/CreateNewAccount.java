...
public class CreateNewAccount {
    By genderr = By.id("uniform-id_gender1");
    ...
    public void createNewUser() {
        ...
        * */
        wait.until(ExpectedConditions.presenceOfElementLocated(genderr));
        //textToBePresentInElementLocated(screenId,"Create an account"));
